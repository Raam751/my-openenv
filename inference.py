...
SYSTEM_PROMPT = textwrap.dedent(
    ...
    - "action_type": one of "view_report", "view_receipt", "verify_receipts", "check_policy", "flag_duplicate", "request_more_info", "approve", "reject"
...
def get_model_action(client: OpenAI, step: int, obs_data: dict, fallback_id: str) -> Action:
    ...
    try:
        ...
        actions = ["view_report", "check_policy", "view_receipt", "verify_receipts", "approve", "reject"]
